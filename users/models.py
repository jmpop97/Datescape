...
class User(AbstractBaseUser):
    ...
    profileimage = models.ImageField(upload_to='profile', blank=True, default='profile/default.png', validators=[FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])])
    LOGIN_TYPE = [
        ('normal', '일반'),
        ('google', '구글'),
        ('kakao', '카카오'),
