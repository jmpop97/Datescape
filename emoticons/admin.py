...
class EmoticonAdmin(admin.ModelAdmin):
    ...
    def make_sale(self, request, queryset):
        ...
        self.message_user(request, '{}건의 항목을 판매중 상태로 변경'.format(updated_count)) #django message framework 활용
    ...
    def make_stop_selling(self, request, queryset):
        ...
        self.message_user(request, '{}건의 항목을 판매중지 상태로 변경'.format(updated_count)) #django message framework 활용
    ...
    def make_delete(self, request, queryset):
        ...
        self.message_user(request, '{}건의 항목을 신청삭제 상태로 변경'.format(updated_count)) #django message framework 활용
